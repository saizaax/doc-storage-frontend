...
import { Accordion, AccordionControlProps, ActionIcon, Box, Menu } from "@mantine/core"
...
export const DocumentMenu: FC<Props> = (props: Props) => {
  ...
  return (
    <>
      ...
      <UploadFileModal id={props.id} opened={openedUpload} close={closeUpload} />
      <Box sx={{ display: "flex", alignItems: "center" }} pr={20}>
        ...
        <Menu shadow="md" width={200}>
          ...
          <Menu.Dropdown>
            ...
            <Menu.Item color="red" icon={<IconTrash size={14} />} onClick={openDelete}>
              Удалить документ
            </Menu.Item>
          </Menu.Dropdown>
        </Menu>
